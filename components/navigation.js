class Navigation extends HTMLElement {
    ...
    connectedCallback() {
		...
		<nav id="nav">
			...
			<ul class="icons">
				...
				<li><a href="https://sketchfab.com/victorghys" class="icon solid fa-cube" target="_blank" rel="noopener noreferrer"><span
  ...
  class NavigationJams extends HTMLElement {
    constructor() {
      super();
    }
    connectedCallback() {
  ...
  customElements.define('navigation-jams-component', NavigationJams);

  class NavigationArt extends HTMLElement {
    constructor() {
      super();
    }
    connectedCallback() {
  ...
  customElements.define('navigation-art-component', NavigationArt);
